...
}catch (e41498){var _e = e41498;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5821__auto___41500 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5821__auto___41500)){
var seen_errors_41501 = temp__5821__auto___41500;
if(cljs.core.truth_(seen_errors_41501.has(self))){
} else {
seen_errors_41501.add(self);

var temp__5823__auto___41502 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5823__auto___41502)){
var sense_41503 = temp__5823__auto___41502;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41503)].join(''));
} else {
}
}
} else {
