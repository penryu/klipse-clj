...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__11251_SHARP_){
return cljs.analyzer.passes.walk.call(null,p1__11251_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.call(null,child,passes,opts);
}
})());
}),(function (){var G__11254 = ast;
if((G__11254 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.call(null,G__11254,passes,opts);
}
