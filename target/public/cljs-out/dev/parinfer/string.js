...
return [cljs.core.subs.call(null,orig,(0),idx),cljs.core.str.cljs$core$IFn$_invoke$arity$1(insert),cljs.core.subs.call(null,orig,idx)].join('');
});
parinfer.string.remove_str_range = (function parinfer$string$remove_str_range(orig,start,end){
return [cljs.core.subs.call(null,orig,(0),start),cljs.core.subs.call(null,orig,end)].join('');
});
/**
