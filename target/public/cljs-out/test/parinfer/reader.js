...
var ch = parinfer.reader.prev_ch.call(null,(function (){var G__28034 = stack;
if(parinfer.reader.escaping_QMARK_.call(null,stack)){
return cljs.core.pop.call(null,G__28034);
} else {
return G__28034;
}
})());
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"parinfer.reader","push-char*"),(function (p__28035){
var map__28036 = p__28035;
var map__28036__$1 = cljs.core.__destructure_map.call(null,map__28036);
var ch = cljs.core.get.call(null,map__28036__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
...
cljs.core._add_method.call(null,parinfer.reader.push_char_STAR_,"\t",(function (p__28037){
var map__28038 = p__28037;
var map__28038__$1 = cljs.core.__destructure_map.call(null,map__28038);
var stack = cljs.core.get.call(null,map__28038__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
...
cljs.core._add_method.call(null,parinfer.reader.push_char_STAR_,new cljs.core.Keyword(null,"open","open",-1763596448),(function (p__28039){
var map__28040 = p__28039;
var map__28040__$1 = cljs.core.__destructure_map.call(null,map__28040);
var state = map__28040__$1;
var stack = cljs.core.get.call(null,map__28040__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
if(parinfer.reader.escaping_QMARK_.call(null,stack)){
...
cljs.core._add_method.call(null,parinfer.reader.push_char_STAR_,new cljs.core.Keyword(null,"close","close",1835149582),(function (p__28041){
var map__28042 = p__28041;
var map__28042__$1 = cljs.core.__destructure_map.call(null,map__28042);
var stack = cljs.core.get.call(null,map__28042__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
var backup = cljs.core.get.call(null,map__28042__$1,new cljs.core.Keyword(null,"backup","backup",26347393));
var ch = cljs.core.get.call(null,map__28042__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
if(parinfer.reader.escaping_QMARK_.call(null,stack)){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"stack","stack",-793405930),cljs.core.pop.call(null,stack)], null);
} else {
if(parinfer.reader.in_code_QMARK_.call(null,stack)){
...
cljs.core._add_method.call(null,parinfer.reader.push_char_STAR_,";",(function (p__28043){
var map__28044 = p__28043;
var map__28044__$1 = cljs.core.__destructure_map.call(null,map__28044);
var state = map__28044__$1;
var stack = cljs.core.get.call(null,map__28044__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
if(parinfer.reader.escaping_QMARK_.call(null,stack)){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"stack","stack",-793405930),cljs.core.pop.call(null,stack)], null);
} else {
if(parinfer.reader.in_code_QMARK_.call(null,stack)){
...
var map__28046__$1 = cljs.core.__destructure_map.call(null,map__28046);
var stack = cljs.core.get.call(null,map__28046__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
var stack__$1 = (function (){var G__28047 = stack;
if(parinfer.reader.escaping_QMARK_.call(null,stack)){
return cljs.core.pop.call(null,G__28047);
} else {
return G__28047;
}
})();
var stack__$2 = (function (){var G__28048 = stack__$1;
if(parinfer.reader.in_comment_QMARK_.call(null,stack__$1)){
return cljs.core.pop.call(null,G__28048);
} else {
return G__28048;
}
})();
...
cljs.core._add_method.call(null,parinfer.reader.push_char_STAR_,"\\",(function (p__28049){
var map__28050 = p__28049;
var map__28050__$1 = cljs.core.__destructure_map.call(null,map__28050);
var state = map__28050__$1;
var stack = cljs.core.get.call(null,map__28050__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
if(parinfer.reader.escaping_QMARK_.call(null,stack)){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"stack","stack",-793405930),cljs.core.pop.call(null,stack)], null);
} else {
...
cljs.core._add_method.call(null,parinfer.reader.push_char_STAR_,"\"",(function (p__28051){
var map__28052 = p__28051;
var map__28052__$1 = cljs.core.__destructure_map.call(null,map__28052);
var state = map__28052__$1;
var stack = cljs.core.get.call(null,map__28052__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
if(parinfer.reader.escaping_QMARK_.call(null,stack)){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"stack","stack",-793405930),cljs.core.pop.call(null,stack)], null);
} else {
if(parinfer.reader.in_str_QMARK_.call(null,stack)){
...
cljs.core._add_method.call(null,parinfer.reader.push_char_STAR_,new cljs.core.Keyword(null,"default","default",-1987822328),(function (p__28053){
var map__28054 = p__28053;
var map__28054__$1 = cljs.core.__destructure_map.call(null,map__28054);
var stack = cljs.core.get.call(null,map__28054__$1,new cljs.core.Keyword(null,"stack","stack",-793405930));
if(parinfer.reader.escaping_QMARK_.call(null,stack)){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"stack","stack",-793405930),cljs.core.pop.call(null,stack)], null);
} else {
return null;
...
return cljs.core.merge_with.call(null,(function (p1__28056_SHARP_,p2__28055_SHARP_){
var or__5002__auto__ = p2__28055_SHARP_;
