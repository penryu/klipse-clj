...
return cljs.core.map.call(null,(function (p1__32358_SHARP_){
return html_coll.item(p1__32358_SHARP_);
...
return cljs.core.some.call(null,(function (p1__32359_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__32359_SHARP_);
...
var ctx_32360 = cvs.getContext("2d");
(ctx_32360.fillStyle = color);

ctx_32360.fillRect((0),(0),size,size);
