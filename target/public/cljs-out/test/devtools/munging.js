...
var o47553 = temp__5821__auto__;
var temp__5821__auto____$1 = (o47553["core"]);
if(cljs.core.truth_(temp__5821__auto____$1)){
var o47554 = temp__5821__auto____$1;
return (o47554["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__46723__auto__ = f;
return (o__46723__auto__["toString"]).call(o__46723__auto__);
} else {
return "";
}
}catch (e47555){var _ = e47555;
return "";
}});
...
try{var o__46723__auto___47557 = t;
(o__46723__auto___47557["cljs$lang$ctorPrWriter"]).call(o__46723__auto___47557,t,writer);
}catch (e47556){var __47558 = e47556;
}
...
var char_code = (function (){var o__46723__auto__ = (new String(char$));
return (o__46723__auto__["charCodeAt"]).call(o__46723__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__46723__auto__ = String;
return (o__46723__auto__["fromCharCode"]).call(o__46723__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__47559 = num_code;
switch (G__47559) {
case (1):
return (185);
...
var o__46723__auto__ = String;
return (o__46723__auto__["fromCharCode"]).call(o__46723__auto__,superscript_code);
});
/**
...
}catch (e47561){var _e__46730__auto__ = e47561;
return false;
}})())){
...
var vec__47562 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__47562,(0),null);
...
var len__5726__auto___47571 = arguments.length;
var i__5727__auto___47572 = (0);
while(true){
if((i__5727__auto___47572 < len__5726__auto___47571)){
args__5732__auto__.push((arguments[i__5727__auto___47572]));

var G__47573 = (i__5727__auto___47572 + (1));
i__5727__auto___47572 = G__47573;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__47567){
var vec__47568 = p__47567;
var ns_detector = cljs.core.nth.call(null,vec__47568,(0),null);
...
var G__47574 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__47575 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__47574;
remaining_tokens = G__47575;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq47565){
var G__47566 = cljs.core.first.call(null,seq47565);
var seq47565__$1 = cljs.core.next.call(null,seq47565);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47566,seq47565__$1);
}));
...
var vec__47579 = cljs.core.split_with.call(null,(function (p1__47578_SHARP_){
return cljs.core.not_EQ_.call(null,p1__47578_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__47579,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__47579,(1),null);
...
var vec__47585 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__47585,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__47585,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__47588 = cljs.core.rest.call(null,remaining_tokens);
var G__47589 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__47588;
name_tokens = G__47589;
continue;
} else {
...
var vec__47592 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__47592,(0),null);
var arity = cljs.core.nth.call(null,vec__47592,(1),null);
var vec__47595 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__47595,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__47595,(1),null);
var vec__47598 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__47598,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__47598,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__47598,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__47598,(3),null);
...
var vec__47604 = result;
var munged_ns = cljs.core.nth.call(null,vec__47604,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__47604,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__47604,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__47604,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__47604,(4),null);
var arity = cljs.core.nth.call(null,vec__47604,(5),null);
...
if(cljs.core.truth_(temp__5821__auto__)){
var vec__47608 = temp__5821__auto__;
var munged_name = cljs.core.nth.call(null,vec__47608,(0),null);
var args = cljs.core.nth.call(null,vec__47608,(1),null);
var vec__47611 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__47611,(0),null);
var name = cljs.core.nth.call(null,vec__47611,(1),null);
...
var G__47614 = (arity + (1));
var G__47615 = (function (){var temp__5821__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5821__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__47616){
var vec__47617 = p__47616;
var arity = cljs.core.nth.call(null,vec__47617,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__47617,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__47620_SHARP_){
return cljs.core.get.call(null,arities,p1__47620_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__47621_SHARP_){
return cljs.core.drop.call(null,(2),p1__47621_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___47628 = arguments.length;
var i__5727__auto___47629 = (0);
while(true){
if((i__5727__auto___47629 < len__5726__auto___47628)){
args__5732__auto__.push((arguments[i__5727__auto___47629]));

var G__47630 = (i__5727__auto___47629 + (1));
i__5727__auto___47629 = G__47630;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__47624){
var vec__47625 = p__47624;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__47625,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq47622){
var G__47623 = cljs.core.first.call(null,seq47622);
var seq47622__$1 = cljs.core.next.call(null,seq47622);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47623,seq47622__$1);
}));
...
var map__47633 = options;
var map__47633__$1 = cljs.core.__destructure_map.call(null,map__47633);
var include_ns_QMARK_ = cljs.core.get.call(null,map__47633__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__47633__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__47633__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__47633__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__47634 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__47634,(0),null);
var fn_name = cljs.core.nth.call(null,vec__47634,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__47634,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__47634,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__47634,(4),null);
var arity = cljs.core.nth.call(null,vec__47634,(5),null);
...
var o__46723__auto__ = f;
return (o__46723__auto__["getBasis"]).call(o__46723__auto__);
});
/**
...
}catch (e47637){var _e__46730__auto__ = e47637;
...
var G__47638 = (obj[cljs.core.first.call(null,path)]);
var G__47639 = cljs.core.rest.call(null,path);
obj = G__47638;
path = G__47639;
continue;
} else {
...
var _STAR_ = (function (accum,p__47640){
var vec__47641 = p__47640;
var bit = cljs.core.nth.call(null,vec__47641,(0),null);
var protocol = cljs.core.nth.call(null,vec__47641,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__47644){
var vec__47645 = p__47644;
var ns = cljs.core.nth.call(null,vec__47645,(0),null);
var name = cljs.core.nth.call(null,vec__47645,(1),null);
var selector = cljs.core.nth.call(null,vec__47645,(2),null);
...
var post_process = (function (p__47649){
var vec__47650 = p__47649;
var munged_name = cljs.core.nth.call(null,vec__47650,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__47650,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__47648_SHARP_){
return (obj[cljs.core.first.call(null,p1__47648_SHARP_)]);
}),sorted_matches);
