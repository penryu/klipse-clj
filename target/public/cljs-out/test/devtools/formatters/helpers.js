...
var G__47669 = devtools.prefs.pref.call(null,v);
v = G__47669;
continue;
} else {
return v;
...
}catch (e47670){var _e__46730__auto__ = e47670;
return false;
}})();
...
}catch (e47672){var _e__46730__auto__ = e47672;
return false;
}})();
...
}catch (e47674){var _e__46730__auto__ = e47674;
return false;
}}
}
});
...
var vec__47676 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__47676,(0),null);
var name = cljs.core.nth.call(null,vec__47676,(1),null);
...
return cljs.core.some.call(null,(function (p1__47679_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__47679_SHARP_);
}),template);
});
